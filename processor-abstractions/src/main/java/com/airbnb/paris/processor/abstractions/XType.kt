...
interface XType {
    ...
    // TODO: 2/21/21 seems wrong? same as isAssignableWithoutVariance
//    /**
...
//    }
    ...
    fun isSameTypeName(other: TypeName, useRawType: Boolean = false): Boolean {
...
fun XType.isFloat(): Boolean = typeName == TypeName.FLOAT || typeName == KnownTypeNames.BOXED_FLOAT

fun XType.isBoolean(): Boolean = typeName == TypeName.BOOLEAN || typeName == KnownTypeNames.BOXED_BOOLEAN
