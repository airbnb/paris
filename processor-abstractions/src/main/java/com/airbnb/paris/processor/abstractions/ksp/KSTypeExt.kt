...
import com.airbnb.paris.processor.abstractions.javac.kotlin.typeNameFromJvmSignature
import com.airbnb.paris.processor.abstractions.tryBox
...
internal fun KSType.withNullability(nullability: XNullability) = when (nullability) {
    com.airbnb.paris.processor.abstractions.XNullability.NULLABLE -> makeNullable()
    com.airbnb.paris.processor.abstractions.XNullability.NONNULL -> makeNotNullable()
