...
import com.airbnb.paris.processor.abstractions.ksp.ERROR_TYPE_NAME
import com.airbnb.paris.processor.abstractions.javac.JavacRawType
import com.airbnb.paris.processor.abstractions.safeTypeName
import com.airbnb.paris.processor.abstractions.javac.extendsBound
import com.google.auto.common.MoreTypes
import javax.lang.model.type.TypeKind
import javax.lang.model.type.TypeMirror
import kotlin.reflect.KClass

 abstract class JavacType(
    ...
    override fun isError(): Boolean {
        return typeMirror.kind == TypeKind.ERROR ||
            ...
            (kotlinType != null && typeName == ERROR_TYPE_NAME) ||
                typeMirror.toString() == ERROR_TYPE_NAME.canonicalName()
    }
