...
import com.airbnb.paris.processor.abstractions.XMessager
import com.airbnb.paris.processor.abstractions.XNullability
...
import com.airbnb.paris.processor.abstractions.javac.DefaultJavacType
...
import com.airbnb.paris.processor.abstractions.javac.JavacProcessingEnvMessager
...
class JavacProcessingEnv(
    ...
    // maybe cache here ?
    fun wrapTypeElement(element: TypeElement): JavacTypeElement = typeElementStore[element]
