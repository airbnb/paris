...
internal class StyleableClassInfo private constructor(val attrs: List<AttrInfo>, val packageName: String, val name: String, val type: TypeMirror, val resourceName: String) {
    ...
    companion object {
        ...
        fun fromElement(element: Element, attrs: List<AttrInfo>): StyleableClassInfo {
            ...
            return StyleableClassInfo(attrs, packageName, name, type, resourceName)
        }
    }
}