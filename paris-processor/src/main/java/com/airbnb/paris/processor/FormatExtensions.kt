...
fun Format.resourcesMethodStatement(): String {
    return when (this) {
        Format.DEFAULT -> ""
...
fun Format.typedArrayMethodStatement(): String {
    return when (this) {
        Format.DEFAULT -> ""
...
fun Format.Companion.forElement(elementUtils: Elements, typeUtils: Types, element: Element): Format {
